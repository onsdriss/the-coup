...
if (level==1)
  ...
  quitter->image=IMG_Load("save.png") ;
  quitter->p.x=0 ;
  quitter->p.y=0;
  ...
  sprite2->clip[0].x=45;
  sprite2->clip[0].y=108;
  sprite2->clip[0].w=121-50;
  sprite2->clip[0].h=293-108 ;

  sprite2->clip[1].x=121;
  sprite2->clip[1].y=108;
  sprite2->clip[1].w=121-65;
  sprite2->clip[1].h=293-108;

  sprite2->clip[2].x=180;
  sprite2->clip[2].y=108;
  sprite2->clip[2].w=121-50;
  sprite2->clip[2].h=293-108;

  sprite2->clip[3].x=121;
  sprite2->clip[3].y=108;
  sprite2->clip[3].w=121-65;
  sprite2->clip[3].h=293-108;

  sprite2->clip[4].x=121;
  sprite2->clip[4].y=108;
  sprite2->clip[4].w=121-50;
  sprite2->clip[4].h=293-108;  
  if(level==1)
  {
  ...
  sprite->clip[0].x=45;
  sprite->clip[0].y=108;
  sprite->clip[0].w=121-50;
  sprite->clip[0].h=293-108;

  sprite->clip[1].x=121;
  sprite->clip[1].y=108;
  sprite->clip[1].w=121-65;
  sprite->clip[1].h=293-108;

  sprite->clip[2].x=180;
  sprite->clip[2].y=108;
  sprite->clip[2].w=121-50;
  sprite->clip[2].h=293-108;

  sprite->clip[3].x=121;
  sprite->clip[3].y=108;
  sprite->clip[3].w=121-65;
  sprite->clip[3].h=293-108;

  sprite->clip[4].x=121;
  sprite->clip[4].y=108;
  sprite->clip[4].w=121-50;
  sprite->clip[4].h=293-108;
  ...
  for (i=0;i<6;i++)
  {
   sprintf(chaine,"ennemi2/%d.png",i+1)  ;
